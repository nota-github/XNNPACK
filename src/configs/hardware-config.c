...
static void init_hardware_config(void) {
  ...
  set_arch_flag(xnn_arch_x86_avx512f, false);
  set_arch_flag(xnn_arch_x86_avx512skx, false);
  set_arch_flag(xnn_arch_x86_avx512vbmi, false);
  set_arch_flag(xnn_arch_x86_avx512vnni, false);
  set_arch_flag(xnn_arch_x86_avx512vnnigfni, false);
  set_arch_flag(xnn_arch_x86_avx512fp16, false);
  set_arch_flag(xnn_arch_x86_avx512bf16, false);
  set_arch_flag(xnn_arch_x86_avx512amx, false);
  set_arch_flag(xnn_arch_x86_avxvnni, false);
  set_arch_flag(xnn_arch_x86_avxvnniint8, false);
  set_arch_flag(xnn_arch_x86_avx256skx, false);
  set_arch_flag(xnn_arch_x86_avx256vnni, false);
  set_arch_flag(xnn_arch_x86_avx256vnnigfni, false);
#if XNN_ARCH_X86_64 && defined(__linux__) && !defined(CHROMIUM)
  if (false) {
